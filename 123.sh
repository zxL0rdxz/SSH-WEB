...
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/whatsapp.sh > /dev/null 2>&1
...
systemctl restart apache2 > /dev/null 2>&1
sed -i "s;Listen 81;g" /etc/apache2/ports.conf
...
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/gestorssh.zip > /dev/null 2>&1
