...
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/sshplus.zip.001 > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/zxL0rdxz/SSH-WEB/main/sincpainel.zip > /dev/null 2>&1
